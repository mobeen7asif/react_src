...
class StampCardDetailMember extends Component {
                                            ...
                                            <div className="e_authorisation_inner clearfix">
                                                <div className="e_authorisation_listLeft">
                                                    <div className="e_authorisation_text"><span>Stamp Card ID</span>
                                                        <strong>{this.props.stamp.id}</strong>
                                                    </div>
                                                </div>
                                                <div className="e_authorisation_listRight">
                                                    <div className="e_authorisation_text"><span>Date</span> <strong>{this.props.stamp.created_at}</strong></div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="e_authorisation_inner clearfix">
                                                <div className="e_authorisation_listLeft">
                                                    <div className="e_authorisation_text"><span>Stamp Card Name</span>
                                                        <strong>{this.props.stamp.name}</strong>
                                                    </div>
                                                </div>
                                                <div className="e_authorisation_listRight">
                                            ...
                                            <div className="e_authorisation_inner clearfix">
                                                <div className="e_authorisation_listLeft width_100">
                                                    <div className="e_authorisation_text">
                                                        ...
                                                        <strong>{this.props.stamp.description}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div className="e_authorisation_inner clearfix">
                                                ...
                                                <div className="e_authorisation_listRight">
                                                    <div className="e_authorisation_text"><span>Store</span>
                                                        <strong>{(this.props.stamp.hasOwnProperty("business")) ? ((this.props.stamp.hasOwnProperty("business") && JSON.parse(this.props.stamp.business).hasOwnProperty('business_name'))?JSON.parse(this.props.stamp.business).business_name:'') : ''}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    className="cL_listing_table_cell cell1 ">
                                                                                           <span
                                                                                               className="cL_rowList_number ">{this.changeDateFormatReport(item.created_at)}</span>
                                                                                </div>
                                                                                <div
...
export default StampCardDetailMember;
