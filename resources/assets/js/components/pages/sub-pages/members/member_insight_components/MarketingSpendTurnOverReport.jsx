...
class MarketingSpendTurnOverReport extends Component {
    constructor(props) {
        super(props);
    }//..... end of constructor() .....//
        ...
        return (
            <React.Fragment>
                <div className="compaign_addNew clearfix">
                    <h3>MARKETING SPEND VS TURNOVER</h3>
                </div>
                        ...
                        <li>
                            <div className="column6_db">
                                <div className="venueHead">
                                    <h4>MARKETING SPEND VS TURNOVER</h4>
...
}//..... end of MarketingSpendTurnOverReport.

MarketingSpendTurnOverReport.propTypes = {};

export default MarketingSpendTurnOverReport;