...
class TransactionAmount extends Component {
    ...
    setCriteriaValue = (value) => {
        this.props.setCriteriaValue('transaction_amount', 'value', value);
        ...
        return (
            <div className="dropSegmentation_section">
                <div className="dropSegmentation_heading clearfix">
                    ...
                    <div className="segmntClose" onClick={(e)=> {this.props.removeCriteria('transaction_amount')}}>
                        ...
                        <div className="memberNumberOuter clearfix">
                            <div className="memberNumber_placeholder">
                                <div className="placeHolderOuter clearfix">
                                    <div className="customDropDown">
                                        <span ref={ref => this.customDropDownSpanRef = ref} onClick={this.handleDropDownSpanClick}>{this.props.criteria.value.status ? this.props.criteria.value.status : 'Transaction Amount'} </span>
                            ...
                            <div className="memberNumbe" style={{width:"51%"}}>
                                <div className="numberFields clearfix">
                                    <input  type="text" placeholder="amount" className="numeric" style={{width:'100%'}} value={this.state.amount} onChange={(e) => {this.handleAmount(e)}}/>
                                </div>
