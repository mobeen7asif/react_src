...
class TotalSpending extends Component {
    ...
    setCriteriaValue = (value) => {
        this.props.setCriteriaValue('total_spending', 'value', value);
        ...
        return (
            <div className="dropSegmentation_section">
                <div className="dropSegmentation_heading clearfix">
                    ...
                    <div className="segmntClose" onClick={(e)=> {this.props.removeCriteria('total_spending')}}>
                            ...
                            <div className="memberNumber_placeholder">
                                <div className="placeHolderOuter clearfix">
                                    <div className="customDropDown">
                                        <span ref={ref => this.customDropDownSpanRef = ref} onClick={this.handleDropDownSpanClick}>{this.props.criteria.value.status ? this.props.criteria.value.status : 'Total Spending'} </span>
