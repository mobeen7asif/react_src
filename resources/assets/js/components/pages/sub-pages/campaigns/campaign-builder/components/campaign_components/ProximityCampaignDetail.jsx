...
class ProximityCampaignDetail extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div>
                ...
                <div className="continueCancel">
                    <input type="submit" value="CONTINUE" onClick={(e) => { this.props.setCurrentTab(++this.currentTab) }} className={(this.props.campaign.name === '' || this.props.campaign.detail === '') ? 'disabled selecCompaignBttn' : 'selecCompaignBttn'}/>
                    <a href="#">CANCEL</a>
                </div>
            </div>
        );
    }//..... end of render() .....//
}//..... end of ProximityCampaignDetail.
...
export default connect(mapStateToProps)(ProximityCampaignDetail);