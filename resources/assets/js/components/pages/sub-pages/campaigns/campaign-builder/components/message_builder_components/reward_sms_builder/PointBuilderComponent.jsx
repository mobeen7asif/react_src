...
import {
    selectMessage,
    selectMessageBuilderObject, selectStatusPoints,
    selectValuePoints
} from "../../../../../../../redux/selectors/Selectors";

class PointBuilderComponent extends Component {
    ...
    quantityUp = (key) => {
        let prevValue = this.props.messageBuilder.other.content.points ? this.props.messageBuilder.other.content.points[key] : 0;
    ...
    setRewardPoints = (value, key) => {
        ...
        if (obj.other.content.points)
            obj.other.content.points[key] = value;
        else
            obj.other.content.points = {[key]: value};
                ...
                <div className="voucher_counter">
                    <div className="dropSegmentation_section">
                        ...
                        <div className="voucher_counter_info">
                            <label>I want to reward Value Points</label>
                            <div className="reward_counter">
                                <div className="fieldIncremnt">
                                    <div className="quantity clearfix">
                                        <input min="1" step="1" type="number" onChange={e => this.setRewardPoints(e.target.value, "Value Points")} value={this.props.valuePoints}/>
                                            <div className="quantity-nav">
                                                <div className="quantity-button quantity-up" onClick={(e)=>{this.quantityUp("Value Points")}}>&nbsp;</div>
                                                <div className="quantity-button quantity-down" onClick={(e)=>{this.quantityDown("Value Points")}}>&nbsp;</div>
                                            </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="voucher_counter_info">
                            <label>I want to reward Status Points</label>
                            <div className="reward_counter">
                                <div className="fieldIncremnt">
                                    <div className="quantity clearfix">
                                        <input min="1" step="1" type="number" onChange={e => this.setRewardPoints(e.target.value, "Status Points")} value={this.props.statusPoints}/>
                                        <div className="quantity-nav">
                                            <div className="quantity-button quantity-up" onClick={(e)=>{this.quantityUp("Status Points")}}>&nbsp;</div>
                                            <div className="quantity-button quantity-down" onClick={(e)=>{this.quantityDown("Status Points")}}>&nbsp;</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
const mapStateToProps = (state) => {
    return {
        ...
        valuePoints     : selectValuePoints(state.campaignBuilder.messageBuilder, state.campaignBuilder.currentChannel),
        statusPoints    : selectStatusPoints(state.campaignBuilder.messageBuilder, state.campaignBuilder.currentChannel)
    };
};
export default connect(mapStateToProps)(PointBuilderComponent);