...
class Reagion extends Component {
    customDropDownSpanRef = null;
    customDropDownShowRef = null;
    constructor(props) {
        super(props);
        this.state = {
            Reagion : [{id:1,group_name:"UK"},{id:2,group_name:"Ireland"}]
        };
    }//..... end of constructor() .....//
    ...
    setCriteriaValue = (value) => {
        this.props.setCriteriaValue('user_region', 'value', value);
        ...
        return (
            <div className="dropSegmentation_section">
                <div className="dropSegmentation_heading clearfix">
                    <h3>User Region</h3>
                    <div className="segmntClose" onClick={(e)=> {this.props.removeCriteria('user_region')}}>
                            ...
                            <div className="memberNumber_placeholder">
                                <div className="placeHolderOuter clearfix">
                                    <div className="customDropDown">
                                        <span ref={ref => this.customDropDownSpanRef = ref} onClick={this.handleDropDownSpanClick}>{this.props.criteria.value.group_name ? this.props.criteria.value.group_name : 'Select Region'} </span>
