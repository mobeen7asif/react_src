...
class GameChannelType extends Component {
    state = {
        totalPercentage :  0,
        totalMembers    :  0,
        chartData       : [],
     ...
     **/
    getSegmentDetails = () => {
        if (this.props.gameMissionTypeToCreate === 'game')
            return false;
                        ...
                        <div className="segment_tYpe_detail">
                            <div className="chanelType_outer chanelType_outer_setting">
                                ...
                                <div className="chanelType_column">
                                    ...
                                    <p>Send information to your members via SMS, Email or at the<br/> Kiosk. SMS and Push notifications are great for short<br/> messages, use email for longer newsletters.</p>
                                </div>
...
export default connect(mapStateToProps)(GameChannelType);