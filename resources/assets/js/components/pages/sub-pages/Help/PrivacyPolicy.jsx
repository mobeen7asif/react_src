...
class PrivacyPolicy extends Component {
    ...
    saveFaq = () => {
        show_loader();
        axios.post(BaseUrl + '/api/save-faqs',{...this.state,venue_id: VenueID,company_id:CompanyID,title:"Privacy Policy"})
            .then(res => {
                this.closePopup();
                this.getContacts();
                show_loader();
                ...
                <div className="contentDetail">
                    ...
                    <div className="autoContent">
                        ...
                        <div className="backSave_buttons" style={{width:"96%"}}>
                            <ul>
                                <li><a  style={{cursor:'pointer'}} className="selecBttn" onClick={()=>{this.openPopup()}} >Add/Update Privacy</a></li>
                            </ul>
                        </div>
