...
class TermAndConditions extends Component {
    ...
    saveFaq = () => {
        show_loader();
        axios.post(BaseUrl + '/api/save-faqs',{...this.state,venue_id: VenueID,company_id:CompanyID,title:"Term And Conditions"})
            .then(res => {
                this.closePopup();
                this.getContacts();
                show_loader();
                            ...
                            <ul>
                                <li>
                                    {(appPermission("Terms And Conditions","add")) && (
                                        <a  style={{cursor:'pointer'}} className="selecBttn" onClick={()=>{this.openPopup()}} >Add/Update Ts & Cs</a>
                                    )}
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="popupDiv2" style={{width:"1024px",left:"33%"}}>
                                <div className="popupDiv_detail">
                                    ...
                                    <div className="popup_heading clearfix">
                                        <h3>ADD Edit Terms and Conditions</h3>
