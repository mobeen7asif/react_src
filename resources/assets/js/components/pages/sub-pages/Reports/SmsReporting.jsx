...
class SmsReporting extends Component {
    perPage = PerPage;
    pageLoader = null;
    state = {
        data            : [],
        ...
        headerList : [
            ...
            {"id": "3", "name": "Sent", "filterName": "processed"},
            {"id": "2", "name": 'Delivered', 'filterName': 'delivered'},
            {"id": "4", "name": 'Undelivered', 'filterName': 'open'},{"id": "5", "name": 'Date', 'filterName': 'open'}],
        showListError:false,
        showAll : false,
                                                                                ...
                                                                                <div
                                                                                    onClick={() => {
                                                                                        this.changeActiveStatus(item)
                                                                                           ...
                                                                                           <span
                                                                                               className="cL_rowList_number">{item.sent}</span>
                                                                                </div>
                                                                                <div
                                                                                    onClick={() => {
                                                                                        this.changeActiveStatus(item)
                                                                                ...
                                                                                <div
                                                                                    onClick={() => {
                                                                                        this.changeActiveStatus(item)
                                                                                           ...
                                                                                           <span
                                                                                               className="cL_rowList_number">{item.undelivered}</span>
                                                                                </div>
                                                                                <div
                                                                                onClick={() => {
                                                                                    this.changeActiveStatus(item)
...
export default connect(mapStateToProps)(SmsReporting);