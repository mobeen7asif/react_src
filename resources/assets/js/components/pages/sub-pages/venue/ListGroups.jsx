...
class ListGroups extends Component {
    ...
    getListGroups = () => {
        show_loader();
        axios.post(BaseUrl + '/api/get-groups',{'order_by':this.state.order_by,'orderData':this.state.orderType,'limit': this.state.perPage, 'offset': this.state.offset,'nameSearch':this.state.searchValue,company_id: CompanyID})
            .then(res => {
    ...
    deleteVenueCategory = (value) => {
        this.setState(() => ({deleteGroupID: value.id}));
    };

    handleCloseModal = () => {
        this.setState(() => ({deleteGroupID: 0}));
    };

    handleDelete = () => {
        let groupID = this.state.deleteGroupID;
        this.setState({deleteGroupID: 0});
        show_loader();
        axios.delete(`${BaseUrl}/api/delete-group/${groupID}`)
            .then((response) => {
                show_loader();
    ...
    setEditGroupData = (group_id,item) => {
        this.props.setEditGroupData(group_id,item);
    ...
    render() {
        return (
            <div>
                    ...
                    <div className="compaigns_list_detail">
                        ...
                        <div className="cL_listing_tableOut memberTable">
                            ...
                            <div className="compaign_addNew clearfix">
                                ...
                                <a  style={{cursor:'pointer'}} className="all_blue_button" onClick={(e)=>{ this.props.createNewGroup() }}>Add New Group</a>
                            </div>
                                ...
                                <div className="cL_listing_tableTitle">
                                    <div className="cL_listing_table_row">
                                        <div className="cL_listing_table_cell cell2">
                                            <strong><span><b><img src="assets/images/sortAerrow_top.png" alt="#" /></b><b><img  src="assets/images/sortAerrow_bottom.png" alt="#" /></b></span>Group Name</strong>
                                        </div>

                                        <div className="cL_listing_table_cell cell4">
                                            <strong><span><b><img  src="assets/images/sortAerrow_top.png" alt="#" /></b><b><img  src="assets/images/sortAerrow_bottom.png" alt="#" /></b></span>Assign Shops</strong>
                                        </div>
                                                    ...
                                                    <div className="listDataShowing">
                                                        <div className="cL_listing_table_row">
                                                            ...
                                                            <div className="cL_listing_table_cell cell2">
                                                                ...
                                                                <span className="cL_rowList_number">{value.group_name}</span>
                                                            </div>


                                                            <div className="cL_listing_table_cell cell4">
                                                                <span className="cL_rowList_number">
                                                                    {(value.group_shops !="" || value.group_shops != NULL) && (

                                                                        JSON.parse(value.group_shops).map((value1,key1)=>{
                                                                            return (
                                                            ...
                                                            <div className="clEditDotes_cell cell6 clearfix"> <span className="cL_rowList_number" style={{marginTop:'5px'}}>

                                                            </span>
                                                                <a className="cl_tableRow_editDotes" onClick={this.handleButtonsShow}  style={{cursor:'pointer'}}><i></i></a> </div>
                                                        ...
                                                        <div className="cl_rowEdit_popOut">
                                                            <div className="cl_rowEdit_pop_table">
                                                                <div className="cl_rowEdit_popOut_tableRow">
                                                                    ...
                                                                    <div className="cl_rowEdit_popOut_tableRow_cell eidtCell1"> <a className="edit_icon"  style={{cursor:'pointer'}} onClick={()=>{this.setEditGroupData(value.id,value)}}> <strong><i>&nbsp;</i>Edit</strong></a> </div>
                ...
                <ConfirmationModal isOpen={!!this.state.deleteGroupID} handleCloseModal={this.handleCloseModal} text={'Group'} handleDeleteItem={this.handleDelete}/>
