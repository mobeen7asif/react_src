                        ...
                        <div className="cL_listing_tableOut memberTable">
                            ...
                            <div className="compaign_select_search clearfix">
                                ...
                                <div className="searchCompaign clearfix">
                                    <input type="text"  placeholder="Search Member" onChange={(e)=>{this.handleChange({searchValue:e.target.value})}}   className="copmpaignSearch_field" />
                            ...
                            <div className="compaign_addNew clearfix">
                                <h3>ALL VENUES</h3>
                                <a  style={{cursor:'pointer'}} className="all_blue_button" onClick={()=>this.addNewCategory()}>Add New Category</a>
                            </div>
                                ...
                                <div className="cL_listing_tableTitle">
                                    <div className="cL_listing_table_row">
                                        ...
                                        <div className="cL_listing_table_cell cell4">
                                            <strong><span><b><img  src="assets/images/sortAerrow_top.png" alt="#" /></b><b><img  src="assets/images/sortAerrow_bottom.png" alt="#" /></b></span>Venues</strong>
                                        </div>
                                                        ...
                                                        <div className="cL_listing_table_row">
                                                            ...
                                                            <div className="cL_listing_table_cell cell4">
                                                                <span className="cL_rowList_number">
                                                                    {value.listAssignVenues.map((value1,key1)=>{
                                                                        return (
                                                                            <strong key={key1} className="news_owner" >{value1.venue_name}</strong>
                                                                        )
                                                                    })}
